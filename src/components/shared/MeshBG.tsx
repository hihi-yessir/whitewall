          ...
          if (!a.blocked) {
            ...
            if (a.blockedAt >= 0) {
              ...
              if (px >= lx - 0.2 && px <= lx + 0.2) {
                ...
                (a.mesh.material as any).color.setHex(0xd94040);
                (a.trail.material as any).color.setHex(0xd94040);
                (a.trail.material as any).opacity = 0.05;
            ...
            if (!a.blocked) {
              ...
              if (px > passX && a.isGood) {
                (a.mesh.material as any).color.setHex(0x2ead6b);
                (a.trail.material as any).color.setHex(0x2ead6b);
              }
              if (px > exitX) { a.dead = true; agentGroup.remove(a.mesh); agentGroup.remove(a.trail); }
            }
          } else {
            const bt = t - a.blockTime;
            (a.mesh.material as any).opacity = Math.max(0, 0.9 - bt * 0.5);
